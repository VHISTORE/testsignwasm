// Импортируем движок внутри воркера
...
self.onmessage = async function(e) {
    ...
    try {
        self.postMessage({ type: 'status', msg: '1/4 Initializing WASM Engine in background...' });
        ...
        // Отправляем готовый файл обратно в главный поток
        self.postMessage({
            type: 'done',
            data: signedIpaData.buffer
        }, [signedIpaData.buffer]);
